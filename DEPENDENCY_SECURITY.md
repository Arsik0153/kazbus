...
- Next.js обновлён с 14.2.3 до 15.5.25, React и React DOM до 19.3.0. Это минимальная поддерживаемая ветка Next.js после [security release за август 2026 года](https://nextjs.org/blog).
