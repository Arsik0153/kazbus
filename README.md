...
Автобусную учётную запись создаёт администратор платформы; самостоятельная
регистрация автобусной компании пока недоступна. Реестра документов автобусов
и удаления аккаунта пассажира в этом выпуске нет. Cargo-документы доступны через
