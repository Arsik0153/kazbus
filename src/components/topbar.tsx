...
const Topbar = (props: Props) => {
    ...
    return (
        <div className="relative flex w-full items-center justify-between overflow-hidden rounded-b-[20px] bg-gradient-to-b from-[#E32828] to-[#E13535] px-5 pb-[26px] pt-[65px]">
