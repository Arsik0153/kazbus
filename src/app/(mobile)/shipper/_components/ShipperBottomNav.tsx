        ...
        >
            <div
                className={cn(
                    ...
                    {
                        'pb-1.25 pt-1.25 xs:pb-2.5 xs:pt-2':
                            hideGap,
                        'pb-5 pt-2.5': !hideGap,
                    }
                )}
                ...
                {SHIPPER_LINKS.map((link) => {
                    ...
                    return (
                        <Link
                            key={link.href}
                            href={link.href}
                            className="flex min-w-0 flex-1 flex-col items-center gap-2 rounded-[0.625rem] px-1.5 pb-3 pt-2 xs:px-3 xs:pb-3.75 xs:pt-2.5"
                        >
