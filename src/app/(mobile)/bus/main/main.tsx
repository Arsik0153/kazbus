...
const MainPage = () => {
    ...
    const handleSearchClick = () => {
        ...
        router.push('/bus/main/tickets?' + updatedSearchParams.toString());
    };
        ...
        <>
            <div className="flex h-full flex-grow flex-col items-center justify-center bg-gradient-to-r from-[#E32828] to-[#E13535]">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <div className="mb-2 mt-0 text-balance px-5 text-2xl font-bold leading-[26.4px] tracking-[-3%] text-white xs:mt-16 xs:text-[32px] xs:leading-[39.6px]">
