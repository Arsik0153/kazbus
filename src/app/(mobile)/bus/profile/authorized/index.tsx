        ...
        <>
            ...
            <div className="flex flex-col justify-center bg-[#FFFFFF] px-5 text-[#4A4A4A]">
                <div className="flex flex-grow flex-col items-center">
                    ...
                    <div className="mt-8 w-full rounded-[10px] bg-[#F9F9F9] px-4 pb-1 pt-6">
                        ...
                        <div className="flex flex-col">
                            <Menu
                                link="/bus/profile/authorized/personal-data"
                                text="Мои личные данные"
                            />
                            <div className="color-[#E9E9E9] h-1 w-full border-b"></div>
                            <Menu
                                link="/bus/profile/authorized/passenger-data"
                            ...
                            <div className="color-[#E9E9E9] h-1 w-full border-t"></div>
                            <Menu
                                link="/bus/profile/authorized/faq"
                                text="FAQ"
                            />
                            <div className="color-[#E9E9E9] h-1 w-full border-t"></div>
                            ...
                            {/* <div className="color-[#E9E9E9] h-1 w-full border-t"></div>
                            <Menu
                                link="/bus/profile/authorized/logout/"
                                text="Выйти из аккаунта"
                            />
                            <div className="color-[#E9E9E9] h-1 w-full border-t"></div>
                            <Menu
                                link="/bus/profile/authorized/delete-account/"
                ...
                <div className="mb-24 flex flex-col gap-2">
                    <Link
                        href="/bus/profile/authorized/logout/"
                        className="flex flex-row items-center justify-center gap-2 rounded-[10px] border border-[#E23333] p-4"
                    >
                        <Door width="20" height="20" color="#D21F1F" />
                        <p className="text-base font-semibold text-[#E23333]">
                            Выйти из аккаунта
                        </p>
                    </Link>
                    <Link
                        href="/bus/profile/authorized/delete-account/"
                        className="flex flex-row items-center justify-center gap-2 rounded-[10px] border border-[#E23333] p-4"
                    >
