...
const CargoMap = () => {
    return (
        <div className="rounded-[0.625rem] border border-[#D1D1D1] bg-white p-4">
            <div className="h-70 flex items-center justify-center rounded-[0.625rem] border border-dashed border-[#E7B0B0] bg-linear-[180deg,#FFF7F7_0%,#FFFFFF_100%] p-6 text-center">
                <div>
                    ...
                    <p className="leading-4.4 mt-2 text-sm text-[#A0A0A0]">
                        Здесь будет отображаться маршрут и позиция транспорта
                    </p>
                </div>
            </div>
        </div>
